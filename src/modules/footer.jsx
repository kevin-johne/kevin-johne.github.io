  ...
  <Wrapper>
    <FooterInner>
      <FooterColumn>
        ...
        <p>
          If you are looking for a frontend developer to transform your ideas to
          well rounded user experiences. Then please contact me via{" "}
          <InlineLink as="a" href={`mailto:${email}`}>
            e-mail
          </InlineLink>{" "}
          or social media. I would like to help.
        </p>
        <SocialMedia>
          <SocialMediaLink
            socialMedia="github"
          ...
          <SocialMediaLink
            ...
            href="https://www.linkedin.com/in/kevin-guy-frontend-engineer/"
            target="_blank"
            rel="noreferrer"
      ...
      <Copyright>
        ...
        <br />
        2013 &mdash; {new Date().getFullYear()} &copy; all rights reserved
        <br />
        <br />
        <InlineLink
          as="a"
          href="https://github.com/kevin-johne/kevin-johne.github.io"
        >
          Source code
        </InlineLink>
      </Copyright>
