...
<section class="mod-features">
    ...
    <div class="feature">
        ...
        <p>
            During the last year I was helping Ströer and Affectv extending their internal AngularJS application. Mainly to improve performance and developing new modules.
        </p>
    </div>
