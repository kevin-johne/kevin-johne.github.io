...
{% block content %}
    ...
    <section class="col-3">
        <p>
            a frontend developer with a degree in B. Sc. in Computer Science from the West Saxony University of Applied
            Science
            in Zwickau, Germany.
        ...
        <p>
            Currently I am available for contract work or employment. I am looking forward to be in a multidisciplinary
            environment with a
            great
